...
#include "com_lame_mp3_utils_LameUtil.h"
#include <stdio.h>
#include <jni.h>

static lame_global_flags *lame = NULL;

JNIEXPORT void JNICALL Java_com_lame_mp3_utils_LameUtil_init(
...
JNIEXPORT jint JNICALL Java_com_lame_mp3_utils_LameUtil_encode(
...
JNIEXPORT jint JNICALL Java_com_lame_mp3_utils_LameUtil_flush(
...
JNIEXPORT void JNICALL Java_com_lame_mp3_utils_LameUtil_close
