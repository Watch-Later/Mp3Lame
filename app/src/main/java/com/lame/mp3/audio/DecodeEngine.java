...
public class DecodeEngine {
    ...
    private void getDecodeData(MediaExtractor mediaExtractor, MediaCodec mediaCodec, String
        ...
        while (!decodeOutputEnd) {
            ...
            if (decodeTime - decodeNoticeTime > AudioConstant.OneSecond) {
                final int decodeProgress =
                        (int) ((presentationTimeUs - startMicroseconds) * AudioConstant
                                .NormalMaxProgress /
                                endMicroseconds);
            ...
            try {
                ...
                if (sourceByteArray.length > 0 && bufferedOutputStream != null) {
                    ...
                    byte[] convertByteNumberByteArray = ConvertByteNumber(byteNumber, AudioConstant
                                    .RecordByteNumber,
                            sourceByteArray);

                    byte[] resultByteArray =
                            ConvertChannelNumber(channelCount, AudioConstant.RecordChannelNumber,
                                    AudioConstant.RecordByteNumber,
        ...
        if (sampleRate != AudioConstant.RecordSampleRate) {
    ...
    private static void Resample(int sampleRate, String decodeFileUrl) {
        ...
        try {
            ...
            new SSRC(fileInputStream, fileOutputStream, sampleRate, AudioConstant.RecordSampleRate,
                    AudioConstant.RecordByteNumber, AudioConstant.RecordByteNumber, 1, Integer.MAX_VALUE,
                    0, 0, true);
